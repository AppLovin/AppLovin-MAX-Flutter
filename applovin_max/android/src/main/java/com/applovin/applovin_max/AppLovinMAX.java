        ...
        implements FlutterPlugin, MethodCallHandler, ActivityAware, MaxAdListener, MaxAdViewAdListener, MaxRewardedAdListener, MaxAdRevenueListener
{
    ...
    static
    {
        ALCompatibleNativeSdkVersions.put( "4.6.4", "13.6.3" );
        ALCompatibleNativeSdkVersions.put( "4.6.3", "13.6.1" );
        ALCompatibleNativeSdkVersions.put( "4.6.2", "13.6.0" );
        ALCompatibleNativeSdkVersions.put( "4.6.1", "13.5.1" );
        ALCompatibleNativeSdkVersions.put( "4.6.0", "13.5.0" );
        ALCompatibleNativeSdkVersions.put( "4.5.2", "13.4.0" );
        ALCompatibleNativeSdkVersions.put( "4.5.1", "13.3.1" );
        ALCompatibleNativeSdkVersions.put( "4.5.0", "13.3.0" );
